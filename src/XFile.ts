...
export namespace XFile {
     ...
     *
     * @returns whether the file exists. 文件是否存在。
     */
     ...
     * @param file file path. 文件路径。
     *
     * @returns file data as ArrayBuffer. 文件数据作为 ArrayBuffer。
     */
     ...
     *
     * @returns whether the directory exists. 文件夹是否存在。
     */
     ...
     * 压缩目录。
     *
     * @param dir unzip path. 压缩路径。
     * @param zip zip file. 压缩文件。
     * @param func callback function. 回调函数。
     */
