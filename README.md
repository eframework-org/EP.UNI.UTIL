...
- **[XCollect](src/XCollect.ts)**: 集合操作工具，提供数组/列表的增删改查、排序等功能
- **[XEnv](src/XEnv.ts)**: 环境检测工具，识别运行时环境、平台特性
- **[XEvent](src/XEvent.ts)**: 事件系统，支持同步/异步事件处理
- **[XFile](src/XFile.ts)**: 文件操作工具，跨平台文件系统操作
